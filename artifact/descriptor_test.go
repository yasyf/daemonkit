...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{"signed-app min_version ok", Descriptor{Schema: 1, Name: "t", Kind: SignedApp, Version: VersionSource{File: "/T.app/Contents/Info.plist", PlistKey: "CFBundleShortVersionString"}, App: &AppSpec{Dir: "/Applications", AppName: "T", Formula: "o/tap/t", MinVersion: "12.28.0"}}, nil},
		{"signed-app min_version not a release triple", Descriptor{Schema: 1, Name: "t", Kind: SignedApp, Version: VersionSource{File: "/T.app/Contents/Info.plist", PlistKey: "CFBundleShortVersionString"}, App: &AppSpec{Dir: "/Applications", AppName: "T", Formula: "o/tap/t", MinVersion: "latest"}}, ErrInvalidDescriptor},
		{"signed-app min_version a dev sentinel", Descriptor{Schema: 1, Name: "t", Kind: SignedApp, Version: VersionSource{File: "/T.app/Contents/Info.plist", PlistKey: "CFBundleShortVersionString"}, App: &AppSpec{Dir: "/Applications", AppName: "T", Formula: "o/tap/t", MinVersion: "9999.1757840000000000000.0-dev"}}, ErrInvalidDescriptor},
		{"signed-app min_version with a static version", Descriptor{Schema: 1, Name: "t", Kind: SignedApp, Version: VersionSource{Static: "12.28.0"}, App: &AppSpec{Dir: "/Applications", AppName: "T", Formula: "o/tap/t", MinVersion: "12.28.0"}}, ErrInvalidDescriptor},
