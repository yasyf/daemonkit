...
| `deploy` | owns sealed installation, activation, supersession, and removal of one fixed signed application. | 17 | 7055 |
...
| `launchd` | is the value-type model for one exact macOS user LaunchAgent and the stateless primitives that apply it. | 15 | 2845 |
