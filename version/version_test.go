...
func TestEqual(t *testing.T) {
	...
	tests := []struct {
		...
		{"tag and bare prerelease", "v12.15.3-rc1", "12.15.3-rc1", true},
		{"prerelease is distinct", "12.15.3", "12.15.3-rc1", false},
		{"different prereleases", "12.15.3-rc1", "12.15.3-rc2", false},
		{"build metadata is distinct", "12.15.3+build.1", "12.15.3+build.2", false},
		{"git-describe suffix is distinct", "v0.8.0-1-gHASH", "0.8.0", false},
